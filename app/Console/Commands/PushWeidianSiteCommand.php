...
class PushWeidianSiteCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'push:weidian';
    ...
    public function handle(): int
    {
        ...
        $platformList = WebsitePlatform::where('status', 'update_success')->where('platform','Weidian')->get();
